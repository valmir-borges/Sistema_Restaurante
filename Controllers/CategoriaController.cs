...
namespace Sistema_Restaurante.Controllers
{
    public class CategoriaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeCategia")] Categoria categoria)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeCategia")] Categoria categoria)
        {
            if (id != categoria.Id)
            {
                return NotFound();
