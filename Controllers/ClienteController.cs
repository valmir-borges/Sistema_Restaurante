...
namespace Sistema_Restaurante.Controllers
{
    public class ClienteController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeCliente,TelefoneCliente,EmailCliente,EnderecoCliente")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeCliente,TelefoneCliente,EmailCliente,EnderecoCliente")] Cliente cliente)
        {
            if (id != cliente.Id)
            {
                return NotFound();
